...
-(void)viewDidAppear:(BOOL)animated
{
    ...
    mSideTableMenu.delegate =self;
    mSideTableMenu.dataSource = self;
...
{
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"SideListCell"];
